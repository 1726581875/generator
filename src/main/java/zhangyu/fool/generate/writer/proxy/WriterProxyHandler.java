...
public class WriterProxyHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        zhangyu.fool.generate.writer.annotation.Writer annotation = codeWriter.getClass().getDeclaredAnnotation(zhangyu.fool.generate.writer.annotation.Writer.class);
        //调用目标方法前，检查目录是否存在
